            ...
            <div className='projects-container'>
                ...
                <div className='project-card'>
                    ...
                    <div className="project-buttons">
                        <a href='https://siamgame.netlify.app' target="_blank">View Project</a>
                        <a href="https://github.com/Diozizo/siam-game" target="_blank">Source Code</a>
                    </div>
                </div>
                ...
                <div className='project-card'>
                    ...
                    <div className="project-buttons">
                        ...
                        <a href="https://github.com/Diozizo/projet_JPO" target="source_code">Source Code</a>
                    </div>
                </div>
